...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
	...
	$(".btn-fixed_catalog").click(function(e) {
		...
		if ($(".header-bottom").is(":hidden")) {
			...
			$(".sandwich_close").addClass("active");
		} else {
			$(".header-bottom").slideUp(200);
			$(".sandwich_close").removeClass("active");
		}
	});

	$(".sandwich_close").click(function() {
		$(".header-bottom").slideUp(200);
		$(".sandwich_close").removeClass("active");
	});
	...
	$('.slider-billbord').slick({
		...
		appendArrows: $(".slider-wrapper .controls-slider"),
		appendDots: $(".slider-wrapper .controls-slider"),
	});
